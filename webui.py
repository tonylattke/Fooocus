...
with shared.gradio_root:
    ...
    with gr.Row():
        with gr.Column(scale=2):
                        ...
                        with gr.Row():
                            ...
                            with gr.Column(visible=modules.config.default_inpaint_advanced_masking_checkbox) as inpaint_mask_generation_col:
                                ...
                                def generate_mask(image, mask_model, cloth_category, dino_prompt_text, sam_model, box_threshold, text_threshold, sam_max_detections, dino_erode_or_dilate, dino_debug):
                                    ...
                                    image = grh.editor_image_only(image)
                                    extras = {}
                                    sam_options = None
            ...
            i2v_tab.select(lambda: 'i2v', outputs=current_tab, queue=False, js=down_js, show_progress="hidden")
            ...
            use_gallery_for_video.click(lambda image: image, inputs=selected_gallery_image,
                                        outputs=video_input_image, queue=False, show_progress="hidden")
            video_model.change(
                ...
                with gr.Column(visible=modules.config.default_developer_debug_mode_checkbox) as dev_tools:
                    ...
                    with gr.Tab(label='Inpaint'):
                        ...
                        inpaint_mask_color.change(
                            lambda x: gr.update(brush=gr.Brush(colors=[x], default_color=x, color_mode="fixed")),
...
shared.gradio_root.launch(
    ...
    allowed_paths=[
        ...
        os.path.join(_script_root, 'javascript'),
        os.path.join(_script_root, 'css'),
        os.path.join(_script_root, 'sdxl_styles'),
    ],
